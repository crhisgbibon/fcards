...
<div id="playSelectMenu" class="fixed z-10 w-full bg-white mx-auto flex flex-col justify-start items-center justify-items-start overflow-y-auto">
  ...
  <div id="selectDeckPanel" class="togglePanels mx-auto flex flex-col justify-start items-center w-full max-w-xs">
    <div id="triggerSelectDeck" class="togglePanelSub max-w-xs w-full max-h-full overflow-y-auto" style="max-height:calc(var(--vh) * 77.5">
      <?php
  ...
  <div id="selectStackPanel" class="togglePanels mx-auto flex flex-col justify-start items-center w-full max-w-xs">
    <div id="triggerSelectStack" class="togglePanelSub max-w-xs w-full max-h-full overflow-y-auto" style="max-height:calc(var(--vh) * 77.5">
      <?php
